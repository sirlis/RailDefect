...
parser.add_argument('--data', type=str, help='path with images and labels folder', default='data/rail400_2048x2000_nc8')
parser.add_argument('--shot', type=int, help='path with images and labels folder', default=1)
...
remainimg = totalimg # exclude support imgs
